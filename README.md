...
> 个人知识库系统 - 用于管理和复习计算机技术知识。支持 Markdown 管理知识点、闪卡记忆、测试复习模式。Flask 网页端展示，SQLite 本地存储，Cloudflare Tunnel 公网分享。AI端（Claude）可读取知识库辅助项目开发。
...
```bash
# 克隆仓库
git clone https://github.com/kangahui69-droid/knowledge-base.git
cd knowledge-base
